...
const StillNotSure = () => {
  ...
  return (
    <div className="bg-lightPrimary w-full py-[130px]">
      <div className="flex justify-center gap-[60px] max-w-[1200px] mx-auto text-blackPrimary">
        <div className="w-1/2 overflow-hidden relative rounded-[10px] h-fit">
          <Image
            alt="any"
            src="/assets/images/faq/sure.webp"
            width={550}
            height={600}
