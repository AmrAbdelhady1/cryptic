...
const LatestNews = () => {
  return (
    <div className="flex flex-col gap-10 pt-20 w-full px-[9vw] text-blackPrimary">
      <div className="flex justify-center w-full">
        <p className="font-medium text-[48px]">Latest news</p>
      </div>
          ...
          >
            <div className="overflow-hidden mb-10 rounded-[10px]">
              <Image
                ...
                width={328}
                height={200}
                className="h-[320px] w-full object-cover rounded-[10px] hover:scale-105 duration-700"
              />
            </div>
            <p className="mb-[5px] uppercase duration-300 ease-in-out hover:text-primary cursor-pointer">
              Entrepreneur
            </p>
            <p className="mb-3 text-[24px] font-medium font-dmSans duration-300 ease-in-out hover:text-primary cursor-pointer">
              {item.name}
            </p>
